...
const HelpPopover = () => {
  return (
    <Popover className="z-50 hidden lg:block md:block shadow-md ">
      <Popover.Button className='flex text-sm duration-150 transition-all px-6 py-2 bg-zinc-800/20 ring-1 ring-zinc-800 hover:ring-zinc-600 hover:text-gray-400 items-center justify-start gap-1 text-zinc-500 rounded-lg' ><MdHelpOutline />
        Help
      </Popover.Button>
      ...
      >
        <Popover.Panel className="z-50 bg-zinc-800/90 backdrop-blur-md rounded-md w-[18rem] text-sm ring-1 ring-zinc-700/60">
          <div className='px-3 py-2 '>
            ...
            <div className='flex flex-col gap-2 '>
              <div className='bg-zinc-700/60 ring-1 ring-zinc-700 w-full flex items-center rounded-md px-2 py-2'>
                ...
                <div className='flex flex-col gap-1 text-[11px] leading-3 w-full'>
            ...
            <div className='bg-zinc-700/60 ring-1 ring-zinc-700 w-full flex flex-col gap-2 rounded-md px-1 py-1 '>
              <Link href="/" className='flex items-center'>
                ...
                <div className='flex flex-col gap-1 text-[11px] leading-3'>
