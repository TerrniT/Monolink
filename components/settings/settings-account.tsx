    ...
    <>
      ...
      <div className="flex pb-8 items-center rounded-sm border-b-2 border-b-zinc-700 w-full"  >
        <div className='py-8'>
          ...
          <Button title='Log Out' className='bg-transparent duration-100 transition-all hover:bg-red-500/20 ring-1 ring-red-500 text-red-500 text-xs text-center  w-14 p-1' onClick={handleSignOut} />
        </div>
      </div>
    </>
  )
