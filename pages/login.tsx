        ...
        <div className="text-white">
          ...
          <form action="#" className='flex flex-col'>
            <div className="mb-4 text-lg">
              <input className="rounded-3xl bg-black bg-opacity-50 border-none px-6 py-3 text-center text-inherit placeholder-gray-500 shadow-lg outline-none backdrop-blur-md" type="email" name="email" id='email' placeholder="enter your email" onChange={(event) => setEmail(event.target.value)} />
            </div>
